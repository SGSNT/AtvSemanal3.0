...
public class BibliotecaController {
	...
	public ResponseEntity<Biblioteca> update(@PathVariable long id,@RequestBody Biblioteca newBiblioteca){
		
		
		try {
			
			Biblioteca biblioteca = this.bibliotecaService.update(id, newBiblioteca);
			return new ResponseEntity<>(biblioteca, HttpStatus.OK);
